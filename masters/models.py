...
class Grade(models.Model):
    ...
    group2 = models.ForeignKey(Group2, on_delete=models.CASCADE, related_name='grades')
...
class Item(models.Model):
    """Item master from Excel"""
    item_master_id = models.CharField(max_length=50, unique=True, db_index=True)
    group2 = models.ForeignKey(Group2, on_delete=models.PROTECT, related_name='items')
    grade = models.ForeignKey(Grade, on_delete=models.PROTECT, related_name='items')
    ...
    class Meta:
        ...
        indexes = [
            ...
            # Removed the index on item_description
        ]
