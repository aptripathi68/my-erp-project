...
COST_HEAD_DEFAULTS = [
    {"code": "RAW_MATERIAL_COST", "name": "Raw Material Cost", "percentage": Decimal("1"), "remarks": "Including Transport"},
    {"code": "INWARD_TRANSPORTATION", "name": "Inward Transportation", "percentage": Decimal("1"), "remarks": ""},
    {"code": "SCRAP_BURNING", "name": "Scrap Burning", "percentage": Decimal("0"), "remarks": ""},
    {"code": "OFFCUT_RECOVERY", "name": "Offcut Recovery", "percentage": Decimal("0"), "remarks": ""},
    {"code": "RAW_MATERIAL_UNLOADING", "name": "Raw Material Unloading at Shop", "percentage": Decimal("1"), "remarks": ""},
    {"code": "TOTAL_RM_COST", "name": "Total RM Cost", "line_type": EstimateCostHead.LineType.TOTAL, "remarks": "Including Material Interest"},
    {"code": "FABRICATION", "name": "Fabrication (Labour & Consumable)", "percentage": Decimal("1"), "remarks": "Bought-Outs Excluded"},
    {"code": "BENDING", "name": "Bending", "percentage": Decimal("1"), "remarks": ""},
    {"code": "JIGG_FIXTURE", "name": "Jigg & Fixture Cost", "percentage": Decimal("1"), "remarks": ""},
    {"code": "ASSEMBLY", "name": "Assembly", "percentage": Decimal("1"), "remarks": ""},
    {"code": "NDT_INSPECTION", "name": "NDT (Inspection)", "percentage": Decimal("1"), "remarks": ""},
    {"code": "INSPECTION", "name": "Inspection", "percentage": Decimal("1"), "remarks": ""},
    {"code": "PAINT_PROCUREMENT", "name": "Paint Procurement", "percentage": Decimal("1"), "remarks": ""},
    {"code": "PRIMER", "name": "PRIMER (Inorganic ethyl zinc silicate)", "percentage": Decimal("1"), "remarks": "@6 LTR/MT"},
    {"code": "MIO", "name": "MIO (Epoxypolyamide MIO)", "percentage": Decimal("1"), "remarks": "@6 LTR/MT"},
    {"code": "FINISH_PAINT", "name": "FINISH PAINT (Aliphatic polyurethane)", "percentage": Decimal("1"), "remarks": "@6 LTR/MT"},
    {"code": "THINNER", "name": "THINNER", "percentage": Decimal("1"), "remarks": ""},
    {"code": "BLASTING_PAINT_APPLICATION", "name": "Blasting & Paint Application", "percentage": Decimal("1"), "remarks": ""},
    {"code": "PAINT_TESTING", "name": "Paint Testing", "percentage": Decimal("1"), "remarks": ""},
    {"code": "LOADING_DISPATCH", "name": "Loading for Dispatch", "percentage": Decimal("1"), "remarks": ""},
    {"code": "PACKING", "name": "Packing", "percentage": Decimal("1"), "remarks": ""},
    {"code": "TRANSPORTATION", "name": "Transportation", "percentage": Decimal("1"), "remarks": "Ex-Works"},
    {"code": "TOTAL_CONVERSION_COST", "name": "Total Conversion Cost", "line_type": EstimateCostHead.LineType.TOTAL, "remarks": ""},
    {"code": "ELECTRICITY", "name": "Electricity", "percentage": Decimal("1"), "remarks": ""},
    {"code": "PLANT_OVERHEAD_FE", "name": "Plant Over Head/FE", "percentage": Decimal("1"), "remarks": ""},
    {"code": "TOTAL_ESTIMATED_COST", "name": "Total Estimated Cost", "line_type": EstimateCostHead.LineType.TOTAL, "remarks": ""},
    {"code": "BANK_INTEREST", "name": "Bank Interest", "percentage": Decimal("1"), "remarks": ""},
    {"code": "MARGIN", "name": "Margin", "percentage": Decimal("1"), "remarks": ""},
