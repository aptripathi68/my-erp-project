...
urlpatterns = [
    ...
    path("<int:project_id>/suppliers/<int:supplier_id>/remove/", views.remove_project_supplier, name="remove_project_supplier"),
    ...
    path("<int:project_id>/quotation/reopen/", views.reopen_quotation_for_review, name="reopen_quotation_for_review"),
